...
from CM6.CM6 import get_f107_index_CM6_deprecated
import warnings
import pytest
...
class test_getSQfield(unittest.TestCase):
    ...
    def get_f107(self,point):
        ...
        difi_t_f107, difi_f107 = get_f107_index_CM6_deprecated.load_coefs()
        start_time = 5114.0
        ...
        sq_t = jd2000_dt.jd2000_dt(point['year'], 
                                   ...
                                   point['hour'],
                                    point['minutes'])
        f107 = get_f107_index_CM6_deprecated.get_f107_index(sq_t, start_time, end_time, difi_f107, difi_t_f107)
